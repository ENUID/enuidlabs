...
const Logo = () => (
  <div className="absolute top-4 left-8 z-50 flex items-center gap-3">
    <img src="/white tab logo .JPG" alt="ENUID Logo" className="h-24 w-auto object-contain" />
    <span className="text-2xl font-normal tracking-widest text-black" style={{ fontFamily: 'Michroma, sans-serif' }}>ENUID</span>
  </div>
);
...
const Blogs = () => {
  return (
    <div className="relative min-h-screen bg-white text-black font-sans">
      ...
      {/* Navigation */}
      <nav className="absolute top-8 right-8 z-50 px-8 py-3 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-lg">
        <div className="flex gap-8 text-xs font-light tracking-wide uppercase">
          ...
          <Link to="/#fluid" className="transition-colors text-black/90 hover:text-black/70">Fluid Orbit</Link>
          <Link to="/#experiments" className="transition-colors text-black/90 hover:text-black/70">Experiments</Link>
        </div>
      </nav>

      {/* Main Content */}
      <div className="relative z-10 pt-32 pb-20 px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-3xl lg:text-8xl text-center font-300 text-black mb-12">
              Journal!
            </h1>

            <h4 className="text-xl mb-8">1. ENUID</h4>

            <div className="space-y-8 pb-10 pl-8 pr-20 lg:pl-16 lg:pr-40">
      ...
      {/* Footer */}
      <footer className="relative z-10 py-20 bg-black">
        <div className="px-12 lg:px-24 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-8 mb-8">
            <div className="flex flex-col gap-2 justify-self-start">
             <div className="text-start pt-8 border-gray-800">
