...
const Logo = () => (
  <div className="absolute top-4 left-4 md:left-8 z-50 flex items-center gap-2 md:gap-3">
    ...
    <span className="text-lg md:text-xl lg:text-2xl font-normal tracking-widest text-black md:text-white" style={{ fontFamily: 'Michroma, sans-serif' }}>ENUID</span>
  </div>
);
    ...
    <div className="relative min-h-screen bg-white md:bg-black text-black md:text-white font-sans overflow-x-hidden">
      ...
      <div className="relative z-10 pt-24 md:pt-32 pb-12 md:pb-20 px-4 md:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-2xl md:text-4xl lg:text-6xl xl:text-8xl text-center font-300 text-black md:text-white mb-8 md:mb-12">
              Journal!
            </h1>

            <h4 className="text-lg md:text-xl mb-6 md:mb-8 pl-4 md:pl-8 lg:pl-16 text-black md:text-white">1. ENUID</h4>

            <div className="space-y-6 md:space-y-8 pb-12 md:pb-16 pl-4 pr-4 md:pl-8 md:pr-12 lg:pl-16 lg:pr-40">
              <p className="text-xs md:text-sm text-black/80 md:text-white/80 leading-relaxed">
              ...
              <p className="text-[10px] pt-4 md:text-xs text-gray-500 md:text-gray-400 leading-relaxed pb-16 md:pb-20 lg:pb-24">
                   by: Team ENUID <br/>
                    Dated: 3/December/2025
              </p>

            <h4 className="text-lg md:text-xl mb-6 md:mb-8 pl-4 md:pl-8 lg:pl-16 pt-24 md:pt-6 text-black md:text-white">2. FLUID ORBIT</h4>

            <div className="space-y-6 md:space-y-6 pb-8 md:pb-10 pl-4 pr-4 md:pl-8 md:pr-12 lg:pl-16 lg:pr-40">
              <p className="text-xs md:text-sm text-black/80 md:text-white/80 leading-relaxed">
              ...
              <p className="text-xs md:text-sm text-black/80 md:text-white/80 leading-relaxed mb-3">
                What Fluid Orbit Does: <br/>
                       <ul className="list-disc pl-6 space-y-2 text-xs md:text-sm text-black/80 md:text-white/80 leading-relaxed -mt-3">
